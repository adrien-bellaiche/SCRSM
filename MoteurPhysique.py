...
class MoteurPhysique(Thread):
    ...
    def f(self,t, y, parametres): # coefficient 4 arbitraire à revoir
        ...
        rp = 0 +(1.0/(3*I[2]) * (SUM[5] - 16*(1/2)*self.rho*(Ce/4)*((e*e+h*h)**(3/2))*(l+e)*h*copysign(r,r)*abs(r)+(I[0]-I[1])*p*q)) # coefficients à revoir, "x4" arbitraire
